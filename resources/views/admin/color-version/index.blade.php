        ...
        <div class="container-fluid mt-4">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="mobile-clock-widget">
                            ...
                            <div>
                                ...
                                <div>
                                    <p class="m-0 f-14 text-light">Dhaka, Bangladesh                                           </p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center text-white">
                                        <h4 class="m-0 f-w-600 num">32°C</h4>
                                        <p class="m-0 f-14">Bangladesh</p>
                                    </div>
                                </div>
                                <div class="media">
                                ...
                                <div class="media">
                                    ...
                                    <!-- cloudDrizzle-->
                                    <div class="media-body align-self-center text-white">
                                        <h4 class="m-0 f-w-600 num">29°C</h4>
                                        <p class="m-0 f-14">Chittagong</p>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 xl-100 box-col-12">
                    ...
                    <div class="card">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h5 class="mt-3">Top 10 Products This Month(Sale)</h5>
                ...
                <div class="col-xl-4 xl-100 box-col-12">
                    <div class="card">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h5 class="mt-3">Top 10 Products This Month(Purchase)</h5>
...
@endif
                ...
                <div class="col-xl-4 xl-100 box-col-12">
                    ...
                    <div class="card">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h5 class="mt-3">Top 10 Customers This Month</h5>
