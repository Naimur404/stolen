	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12">
							...
							<div class="row">
								<div class="col">
									<div class="mb-3 mt-2">
										...
										<select id="sel_emp" style="width: 1600px;">
              ...
              <div class="checkbox checkbox-primary">
                <input id="checkbox-primary-1" type="checkbox" value="{{ $data->id }}" name="permission[]">
                <label for="checkbox-primary-1" >{{ $data->name }}</label>
                </div>
                @endforeach
                </div>
              </div>
