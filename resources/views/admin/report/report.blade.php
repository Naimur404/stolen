            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-2">Start Date <strong class="text-danger">*</strong> {{ Form::text('start_date', null, ['class'=>'datepicker-here form-control digits', 'required','data-language'=>'en','placeholder'=>'dd / mm / yyyy']) }}</div>
                        <div class="col-md-2">End Date {{ Form::text('end_date', \Carbon\Carbon::today()->format('d-m-Y'), ['class'=>'datepicker-here form-control digits', 'required','data-language'=>'en','placeholder'=>'dd / mm / yyyy']) }}</div>
...
@can('sale_report_by_payment')
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-2">Start Date <strong class="text-danger">*</strong> {{ Form::text('start_date', null, ['class'=>'datepicker-here form-control digits','data-language'=>'en','placeholder'=>'dd / mm / yyyy']) }}</div>
                        <div class="col-md-2">End Date {{ Form::text('end_date', \Carbon\Carbon::today()->format('d-m-Y'), ['class'=>'datepicker-here form-control digits','data-language'=>'en','placeholder'=>'dd / mm / yyyy']) }}</div>
