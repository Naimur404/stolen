...
@section('title','Supplier Wise Medicine Sales Report')
...
<div class="row all-content">
    ...
    <div class="col-md-12">
        ...
        <p class="text-center">Grand Total {{ $grand_total }} | Total Quantrity {{ $total_quantity }} | Total Discount {{ $total_discount }}</p>
