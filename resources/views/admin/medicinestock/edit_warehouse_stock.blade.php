...
<div class="col-md-12 col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['route' => 'warehouse-stock-update', 'method' => 'POST', 'class' => 'needs-validation', 'novalidate'=> '']) !!}


                <input type="hidden" name="id" value="{{ $warehouseStock->id }}">
            ...
            <table class="table table-bordered mt-2">
                <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="purchase_price" id="price" value="{{ $warehouseStock->purchase_price }}" step="any" class="form-control" required readonly>
                           </td>
