...
@section('title')
    Add Distribute Product to Outlet
@endsection
@push('css')
    <style>
        .delete {
...
@section('content')
    @component('components.breadcrumb')
        @slot('breadcrumb_title')
            <div class="row">
                <div class="col-sm-8">
                    <h3>Add Distribute Product to Outlet</h3>
                </div>
        ...
        @slot('button')
            <a href="{{ route('distribute-medicine.index') }}" class="btn btn-primary btn"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input class="datepicker-here form-control digits" type="text" data-language="en"
                               data-bs-original-title="" title="" name="purchase_date"
                               value="{{ Carbon\Carbon::today()->format('d-m-Y') }}" tabindex="2" required>
